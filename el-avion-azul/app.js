...
function selectColor(color) {
    ...
    if (color === 'blue') {
        ...
        promptText.appendChild(document.createTextNode('¡EL AVIÓN ES '));
        ...
        promptText.textContent = '';
        promptText.appendChild(document.createTextNode(`¡Pintaste el avión de ${colorNames[color]}! ¡Ahora hazlo `));
        const span = document.createElement('span');
        span.className = 'highlight-blue';
        span.textContent = 'AZUL';
        promptText.appendChild(span);
